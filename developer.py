...
class Developer:
    def __init__(self,root):
        ...
        img_top=Image.open(r"C:\Users\amanc\OneDrive\Desktop\Attendance-Management-System-using-OpenCV-main\Attendance-Management-System-using-OpenCV-main\Images\dev.jpg")
        ...
        img_l=Image.open(r"C:\Users\amanc\OneDrive\Desktop\Attendance-Management-System-using-OpenCV-main\Attendance-Management-System-using-OpenCV-main\Images\developergif.gif")
        ...
        # Developer Info
        dev_lb=Label(main_frame,text="Daksh Bisht",font=("time new roman",15,"bold"),bg="white",fg="#142552")
        dev_lb.place(x=10,y=45)

        dev_lb=Label(main_frame,text="Aman Chand",font=("time new roman",15,"bold"),bg="white",fg="#142552")
        dev_lb.place(x=10,y=85)

        dev_lb=Label(main_frame,text="Gaurav Rana",font=("time new roman",15,"bold"),bg="white",fg="#142552")
        dev_lb.place(x=10,y=125)
