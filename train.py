...
class Train:
    def __init__(self,root):
        ...
        img_top = Image.open(r"C:\Users\amanc\OneDrive\Desktop\Attendance-Management-System-using-OpenCV-main\Attendance-Management-System-using-OpenCV-main\Images\re2.jpg")
    ...
    def train_classifier(self):
        ...
        try:
            ...
            # If cv2.face module is not available, use cv2.face_LBPHFaceRecognizer
            clf = cv2.face.LBPHFaceRecognizer_create()
        clf.train(faces,ids)
        clf.write(r"C:\Users\amanc\OneDrive\Desktop\Attendance-Management-System-using-OpenCV-main\Attendance-Management-System-using-OpenCV-main\classifier.xml")
